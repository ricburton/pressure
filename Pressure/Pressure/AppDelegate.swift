...
//        let masterVC : MasterViewController = MasterViewController.alloc()
        
//        let masterVC = self.window!.rootViewController as MasterViewController
        
        
//        BAMasterViewController *rootVC = [[BAMasterViewController alloc] initWithNibName:@"BAMasterViewController" bundle:nil];
